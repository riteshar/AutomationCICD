...
import riteshsharma.pageobjects.OrderPage;
...
public class SubmitOrderTest extends BaseTest{
	...
	public Object[][] getData() throws IOException
	{
		...
		List<HashMap<String,String>> data = getJsonDataToMap(System.getProperty("user.dir")+"//src//test//java//riteshsharma//data//PurchaseOrder.json");
